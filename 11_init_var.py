...
class Person:
    ...
    # class variable
    organization: ClassVar[str] = "ABC Company"
    # other data members
...
if __name__ == '__main__':
    person_d1 = Person(100,'Guido','M',salary_grade='A1')
    person_d2 = Person(200,'Eric V Smith','M',salary_grade='A3')
