...
class Person:
    ...
    person_id: int = field(hash=True,compare=True,metadata={'description':'PersonId should be unique'})
    name: str = field(compare=False,hash=False)
    gender: str = field(hash=False,compare=False)
